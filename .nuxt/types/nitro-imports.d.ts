declare global {
  ...
  const JQLParser: typeof import('../../server/utils/jqlParser').JQLParser
  const WorkflowEngine: typeof import('../../server/utils/workflowEngine').WorkflowEngine
...
declare global {
  ...
  // @ts-ignore
  export type { JQLParser } from '../../server/utils/jqlParser'
  import('../../server/utils/jqlParser')
  // @ts-ignore
  export type { WorkflowEngine } from '../../server/utils/workflowEngine'
  import('../../server/utils/workflowEngine')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'D:/Documents/GitHub/JIRA-REN/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'D:/Documents/GitHub/JIRA-REN/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { JQLParser } from 'D:/Documents/GitHub/JIRA-REN/server/utils/jqlParser';
export { WorkflowEngine } from 'D:/Documents/GitHub/JIRA-REN/server/utils/workflowEngine';